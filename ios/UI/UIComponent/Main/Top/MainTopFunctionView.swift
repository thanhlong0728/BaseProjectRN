...
class MainTopFunctionView: UIView {
    //icBackWhite
    let kMainTopFunctionSettingButtonName = "icBack"
    ...
    @IBAction func settingButtonAction(_ sender: UIButton) {
      let parentController = self.parentController(of: MainViewController.self)
      print("settingButtonAction ... ")
      RNEventEmitter.emitter.sendEvent(withName: "onFinished",body: "back")
