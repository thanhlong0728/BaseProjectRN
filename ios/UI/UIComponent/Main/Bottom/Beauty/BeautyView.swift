...
//      var typeBeauty=beautyIndex
//      if(Int(beautyIndex) == 1){
//        typeBeauty=13
//
//      }
...
//            let beautyValue = BeautyManager.shared.getBeautyValue(type: ARGContentItemBeauty(rawValue: selectedIndexPath.row) ?? .vline)
          slider.setValue(BeautyManager.shared.sliderValues[selectedIndexPath.row], animated: false)
        }
    }
    
    @IBAction func sliderValueChanged(_ sender: UISlider) {
     
//      var typeBeauty = sender.tag
//      if(Int(sender.tag) == 1){
//        typeBeauty=13
//
//      }
