...
class RealmManager {
    ...
    func setARGearData(_ data: Dictionary<String, Any>?, completion: RealmCompletion?) {
        ...
        try! realm.write {
            ...
            // delete categories
            let dbCategories = realm.objects(Category1.self)
    ...
    func getCategories() -> [Category1] {
        let realm = try! Realm()
        
        var categories: [Category1] = [Category1]()
        for category in realm.objects(Category1.self) {
